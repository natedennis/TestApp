...
*/
    ...
    private Descriptor currentDemo;
    ...
    public Descriptor getCurrentDemo() {
    ...
    public Descriptor findDemoById(String id) {
        Iterator<GroupDescriptor> it = groups.iterator();
        while (it.hasNext()) {
            GroupDescriptor group = it.next();
            Iterator<Descriptor> dit = group.getDemos().iterator();
            while (dit.hasNext()) {
                Descriptor locDemo = (Descriptor) dit.next();
    ...
    public String getSampleURI() {
        ...
        if (handler instanceof ConfigurableNavigationHandler) {
            ...
            NavigationCase navCase = navigationHandler.getNavigationCase(context, null, "/mobile/richfaces"+ SEPARATOR +  getCurrentDemo().getId() + SEPARATOR
                    + getCurrentSample().getId());
            
         //   System.out.println(navCase.toString());
